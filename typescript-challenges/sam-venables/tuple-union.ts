...
export type ObjectToTuple<T> = T extends Record<number, any>
	...
	? _BuildTuple<T, []>
	: never;
type _BuildTuple<T extends Record<number, any>, Result extends any[] = []> = keyof T extends never
...
export type ObjectUnion<T1 extends Record<any, any>, T2 extends Record<any, any>> =
...
type Sam_TupleUnion<T1 extends any[], T2 extends any[]> =
	ObjectToTuple<
		ObjectUnion<
			TupleToObject<T1>,
			TupleToObject<T2>
